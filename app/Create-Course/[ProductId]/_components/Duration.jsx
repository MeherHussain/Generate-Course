...
const Duration = ({ course }) => {
  const extractHours = (duration) => {
    const match = duration?.match(/\d+-?\d*/); // Extracts the numeric part (e.g., "15-20")
    return match ? match[0] : "N/A"; // Returns the matched value or "N/A" if no match
  };
      ...
      <div className="card">
        <div className="c-txt">
          ...
          <h2 className="font-bold">
            {extractHours(course?.courseOutput?.duration)} Hours{" "}
